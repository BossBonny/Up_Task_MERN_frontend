                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        ...
                                        <input
                                            type='submit'
                                            className='bg-sky-600 hover:bg-sky-700 w-full p-3 text-white uppercase font-bold cursor-poiner transition-colors rounded text-sm'
                                            value={id ? 'Guadar Cambios' : 'Crear Tarea'}
                                        />
                                    </form>
                                </div>
                            </div>
